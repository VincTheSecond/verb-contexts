...
type2=`echo ${CONFIG}_${REMOVE} | cut -d"_" -f7- | paste -d","`
...
python remove_contexts.py --remove $type2 --input $DATA/exp_${lang}_${pos}_${name}/dep.contexts.$type1 --output ../data/$exp/dep.contexts $merge_flag
